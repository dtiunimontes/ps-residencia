    ...
    <div class="col-md-12" style="position:absolute; top: 5cm;">
        <div class="col-md-12" id="indigena">
            <div class="col-md-12 text-uppercase text-center">
                <h2><strong>Folha de identificação - Pedido de Isenção</strong></h2>
            </div><br><br><br>
        ...
        <div class="col-md-12 text-center">
            {!! DNS1D::getBarcodeHTML(str_pad($inscricao->inscricao_id, 10, "0", STR_PAD_LEFT), "C128", 1.5, 50) !!}
        </div>
        <div style="margin-left: 50px">
            {{ str_pad($inscricao->inscricao_id, 10, "0", STR_PAD_LEFT) }}
        </div>
